...
public class Day2 {
    ...
    final String examplePath = "src/main/java/org/example/y2023/data/Day2_part1_example.txt";
    final String inputPath = "src/main/java/org/example/y2023/data/Day2_input.txt";
