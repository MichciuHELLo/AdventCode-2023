...
public class Day4 {
    ...
    final String examplePathPart1 = "src/main/java/org/example/y2023/data/Day4_part1_example.txt";
    final String inputPath = "src/main/java/org/example/y2023/data/Day4_input.txt";
